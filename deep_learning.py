...
model_save_path = '../python_signLangs_project/model/keypoint_classifier/keypoint_classifier.hdf5'
...
tflite_save_path = '../python_signLangs_project/model/keypoint_classifier/keypoint_classifier.tflite'
