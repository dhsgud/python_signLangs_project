...
hand_sign_string = load_hand_sign_string('../python_signLangs_project/hand_sign_string.json')
...
def get_args():
    ...
    parser.add_argument("--start_id", help='start id', type=int, default=50) #해당하는 hand_sign_string.json 보다 -1 해야함 꼭!!
    parser.add_argument("--duration", help='duration in seconds', type=int, default=30)
...
def save_hand_sign_id(hand_sign_label):
    ...
    if hand_sign_label != last_saved_hand_sign_label:
        ...
        if current_time - last_hand_sign_change_time >= 1:
            ...
            with open('../python_signLangs_project/hand_sign.txt', 'a', encoding='utf-8') as file:
